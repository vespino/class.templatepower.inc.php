...
class TemplatePowerParser
{
     ...
     * @access private
     */
  /*  Add this To Fix PHP Deprecated:  Methods with the same name as their class will not be
   *  constructors in a future version of PHP;
   *  SubClass has a deprecated constructor 
   *  By Samoual Shingrai 
  */
...
class TemplatePower extends TemplatePowerParser
{
     ...
     * @access public
     */
   public function __construct ($tpl_file = null, $type = T_BYFILE) {
   ...
   public function TemplatePower ($tpl_file = null, $type = T_BYFILE)
    {
		/* removed To work with php7 old php show error
        TemplatePowerParser::TemplatePowerParser( $tpl_file, $type );
        $this->prepared = false;
        $this->showUnAssigned = false;
        $this->serialized = false;
